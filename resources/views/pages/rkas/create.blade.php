<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            <a href="{{ route('rkas.index', ['academic_year_id' => $academicYear->id]) }}" class="p-3 bg-white dark:bg-gray-950 border border-gray-100 dark:border-gray-800 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-900 transition-all flex items-center justify-center text-gray-400 hover:text-red-600">
            ...
            <div>
                ...
                <p class="text-sm text-gray-400 mt-1 uppercase tracking-widest font-black">Tahun Pelajaran: <span class="text-red-600">{{ $academicYear->year }}</span></p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 pb-24">
            <div class="bg-white dark:bg-gray-950 rounded-[40px] border border-gray-100 dark:border-gray-800 shadow-2xl overflow-hidden animate-fadeIn">
                <form action="{{ route('rkas.store') }}" method="POST" class="p-10">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="kode_lokasi" placeholder="Contoh: 01.01.01" value="{{ old('kode_lokasi') }}"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="struktur_pp" value="{{ old('struktur_pp') }}"
                                class="w-full px-6 py-4 rounded-2xl border-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 shadow-sm font-bold">
                        </div>
                        <div class="space-y-2">
                            <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] px-1">Program (Nama PP)</label>
                            <div class="flex gap-2">
                                <input type="text" name="kode_pp" placeholder="Kode" class="w-24 px-4 py-4 rounded-2xl border-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 shadow-sm font-bold">
                                <input type="text" name="nama_pp" placeholder="Nama Program" class="flex-1 px-6 py-4 rounded-2xl border-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 shadow-sm font-bold">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="kode_rkm" value="{{ old('kode_rkm') }}"
                                class="w-full px-6 py-4 rounded-2xl border-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 shadow-sm font-bold">
                        </div>
                        <div class="space-y-2 md:col-span-2">
                            ...
                            <div class="flex gap-2">
                                <input type="text" name="kode_drk" placeholder="Kode" class="w-24 px-4 py-4 rounded-2xl border-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 shadow-sm font-bold">
                                <input type="text" name="nama_drk" placeholder="Nama DRK" class="flex-1 px-6 py-4 rounded-2xl border-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 shadow-sm font-bold">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="mta" placeholder="Contoh: 5.1.01" value="{{ old('mta') }}"
                                class="w-full px-6 py-4 rounded-2xl border-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 shadow-sm font-bold">
                        </div>
                        <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="sumber_anggaran" placeholder="Contoh: BOS / Yayasan" value="{{ old('sumber_anggaran') }}"
                                class="w-full px-6 py-4 rounded-2xl border-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 shadow-sm font-bold">
                        </div>
                        <div class="md:col-span-3 space-y-2">
                            ...
                            <textarea name="rincian_kegiatan" rows="3"
                                class="w-full px-6 py-4 rounded-3xl border-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 shadow-sm font-bold">{{ old('rincian_kegiatan') }}</textarea>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="number" step="any" name="quantity" value="{{ old('quantity', 0) }}"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="satuan" placeholder="Contoh: Orang / Hari" value="{{ old('satuan') }}"
                                class="w-full px-6 py-4 rounded-2xl border-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 focus:border-red-500 shadow-sm font-bold text-center">
                        </div>
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="tarif" value="{{ old('tarif', 0) }}"
                    ...
                    <div class="flex justify-end mt-12 pt-8 border-t border-gray-50 dark:border-gray-900 gap-4">
                        <a href="{{ route('rkas.index', ['academic_year_id' => $academicYear->id]) }}" 
