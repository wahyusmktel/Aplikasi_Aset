    ...
    <div x-data="crud">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="flex flex-wrap gap-2 justify-between items-center mb-6">
                            ...
                            <form action="{{ route('persons-in-charge.index') }}" method="GET">
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="py-3 px-6">Nama Penanggung Jawab</th>
                                ...
                                <tbody>
                                    @forelse ($personsInCharge as $index => $person)
                                        <tr
                                            ...
                                            <td class="py-4 px-6">{{ $person->code }}</td>
                                            <td class="py-4 px-6 flex space-x-2">
                                                <button
                                                    @click="showModal = true; isEditMode = true; form.name = '{{ $person->name }}'; form.id = {{ $person->id }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="py-4 px-6 text-center">Tidak ada data penanggung
                                                jawab.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
        ...
        <div x-show="showModal" x-cloak
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md"
                ...
                <h2 class="text-2xl font-bold mb-6"
                    x-text="isEditMode ? 'Edit Penanggung Jawab' : 'Tambah Penanggung Jawab Baru'"></h2>
                <form :action="isEditMode ? '/persons-in-charge/' + form.id : '{{ route('persons-in-charge.store') }}'"
                    method="POST">
                    @csrf
        ...
        <div x-show="showImportModal" x-cloak
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md"
                ...
                <h2 class="text-2xl font-bold mb-6">Impor Data Penanggung Jawab</h2>
                <form action="{{ route('persons-in-charge.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                        ...
                        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Pastikan file Excel memiliki header:
                            <strong>nama_penanggung_jawab</strong>.</p>
                    </div>
                    <div class="flex justify-end space-x-4">
