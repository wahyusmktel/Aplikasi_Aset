        ...
        <div
            ...
            @else
                ...
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- Tombol Lapor Kerusakan untuk User Login --}}
                    @auth
                        <div class="mt-8 pt-8 border-t border-gray-100 dark:border-gray-700 flex justify-center">
                            <a href="{{ route('asset-reports.create', ['asset_code' => $asset->asset_code_ypt]) }}" 
                               class="inline-flex items-center px-8 py-4 bg-rose-600 hover:bg-rose-700 text-white font-bold rounded-2xl shadow-xl shadow-rose-500/20 transition-all hover:scale-105 active:scale-95 group">
                    ...
                    @else
                        <div class="mt-8 pt-8 border-t border-gray-100 dark:border-gray-700 text-center">
                            <p class="text-xs text-gray-400 mb-4">Ingin melaporkan kerusakan? Silakan login terlebih dahulu.</p>
                            <a href="{{ route('login') }}" class="inline-flex items-center px-6 py-3 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 font-bold rounded-xl hover:bg-gray-200 transition-all">
                                Login Ke Sistem
                            </a>
                        </div>
                    @endauth
