...
<head>
    ...
    {{-- Logika Vite ini sudah benar dan diambil dari file aslimu --}}
    @if (file_exists(public_path('build/manifest.json')) || file_exists(public_path('hot')))
        @vite(['resources/css/app.css', 'resources/js/app.js'])
    @else
        {{-- Ini adalah fallback jika Vite tidak jalan, biarkan saja --}}
        <style>
...
{{-- GANTI BODY DENGAN YANG LEBIH BAIK --}}
...
<body class="font-sans antialiased bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    <div class="relative min-h-screen flex flex-col items-center justify-center">
        ...
        <main class="w-full max-w-4xl px-6 lg:px-8 text-center">
            <div>

                <svg class="w-20 h-20 mx-auto text-blue-500" fill="none" stroke-width="1.5" stroke="currentColor"
                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9M21.75 7.5v9c0 1.148-.56 2.166-1.469 2.752L12 21.75l-8.281-4.748C2.81 16.416 2.25 15.398 2.25 14.25v-9c0-1.148.56-2.166 1.469-2.752L12 2.25l8.281 4.748C21.19 7.584 21.75 8.602 21.75 9.75V7.5z">
                    </path>
                </svg>
            </div>
            ...
            <h2 class="mt-2 text-2xl font-medium text-blue-600 dark:text-blue-400">
                SMK Telkom Lampung
            </h2>

            <p class="mt-6 text-lg leading-relaxed text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Selamat datang di portal manajemen aset. Silakan login untuk mengelola, melacak, dan memonitor semua
        ...
        <footer class="py-6 text-center text-sm text-gray-500 dark:text-gray-400 mt-12 absolute bottom-0">
