    ...
    <div x-data="crud">
                                ...
                                <tbody>
                                    @forelse ($categories as $index => $category)
                                        <tr
                                            ...
                                            <td class="py-4 px-6">{{ $category->code }}</td>
                                            <td class="py-4 px-6 flex space-x-2">
                                                <button
                                                    @click="showModal = true; isEditMode = true; form.name = '{{ $category->name }}'; form.id = {{ $category->id }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="py-4 px-6 text-center">Tidak ada data kategori.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
        ...
        <div x-show="showModal" x-cloak
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md"
                ...
                <h2 class="text-2xl font-bold mb-6" x-text="isEditMode ? 'Edit Kategori' : 'Tambah Kategori Baru'"></h2>
                <form :action="isEditMode ? '/categories/' + form.id : '{{ route('categories.store') }}'"
                    method="POST">
                    @csrf
        ...
        <div x-show="showImportModal" x-cloak
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md"
                ...
                <h2 class="text-2xl font-bold mb-6">Impor Data Kategori</h2>
                <form action="{{ route('categories.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" name="file" id="file"
                            ...
                            required>
                        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Pastikan file Excel Anda memiliki kolom
                            header: <strong>nama_kategori</strong>.</p>
                    </div>
                    <div class="flex justify-end space-x-4">
