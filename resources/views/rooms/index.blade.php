    ...
    <div x-data="crud">
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="py-3 px-6">Nama Ruangan</th>
                                ...
                                <tbody>
                                    @forelse ($rooms as $index => $room)
                                        <tr
                                            ...
                                            <td class="py-4 px-6 flex space-x-2">
                                                <button
                                                    @click="showModal = true; isEditMode = true; form.name = '{{ $room->name }}'; form.id = {{ $room->id }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="py-4 px-6 text-center">Tidak ada data ruangan.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
        ...
        <div x-show="showModal" x-cloak
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md"
                ...
                <h2 class="text-2xl font-bold mb-6" x-text="isEditMode ? 'Edit Ruangan' : 'Tambah Ruangan Baru'"></h2>
                <form :action="isEditMode ? '/rooms/' + form.id : '{{ route('rooms.store') }}'" method="POST">
                    @csrf
        ...
        <div x-show="showImportModal" x-cloak
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md"
                ...
                <h2 class="text-2xl font-bold mb-6">Impor Data Ruangan</h2>
                <form action="{{ route('rooms.import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                            Pastikan file Excel Anda memiliki kolom header: <strong>nama_ruangan</strong>.
                            {{-- Anda bisa membuat route untuk download template jika perlu --}}
                            {{-- <a href="#" class="text-blue-500 hover:underline">Unduh Template</a> --}}
                        </p>
                    </div>
                    <div class="flex justify-end space-x-4">
