    ...
    <div x-data="crud">
                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="py-3 px-6">Nama Prodi / Unit</th>
                                ...
                                <tbody>
                                    @forelse ($departments as $index => $department)
                                        <tr
                                            ...
                                            <td class="py-4 px-6">{{ $department->code }}</td>
                                            <td class="py-4 px-6 flex space-x-2">
                                                <button
                                                    @click="showModal = true; isEditMode = true; form.name = '{{ $department->name }}'; form.id = {{ $department->id }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="py-4 px-6 text-center">Tidak ada data prodi/unit.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
        ...
        <div x-show="showModal" x-cloak
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md"
                ...
                <h2 class="text-2xl font-bold mb-6" x-text="isEditMode ? 'Edit Prodi/Unit' : 'Tambah Prodi/Unit Baru'">
                </h2>
                <form :action="isEditMode ? '/departments/' + form.id : '{{ route('departments.store') }}'"
                    method="POST">
                    @csrf
        ...
        <div x-show="showImportModal" x-cloak
            ...
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-xl w-full max-w-md"
                ...
                <h2 class="text-2xl font-bold mb-6">Impor Data Prodi/Unit</h2>
